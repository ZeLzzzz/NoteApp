<nav class="z-0 flex items-center justify-between px-4 md:px-6 py-2 bg-white border-b border-gray-300">
    ...
    <div class="flex items-center select-none">
        <div class="flex items-center" x-data="{ dropDownUser: false }">
                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full mx-auto">
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="flex items-center justify-end p-2 md:p-3 border-t border-gray-200 rounded-b">
                                    ...
                                    <button data-modal-hide="static-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center">Here!</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                <p class="mr-2 text-gray-600 font-semibold text-xs md:text-base md:mr-4">{{ Auth::user()->company->company_name }}</p>
            @endif
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-4 md:p-5 flex items-center">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        @if (Auth::user()->type == 'P')
                                            <p class="text-sm leading-relaxed text-gray-500 mx-2">You are the one who built the company <a href="{{ route('Company Information') }}" class="text-blue-500 hover:underline">{{ Auth::user()->company->company_name }}</a></p>
                                        @else
                                ...
                                <div class="flex items-center justify-end p-2 md:p-3 border-t border-gray-200 rounded-b">
                                    ...
                                    <a href="{{ route('Profile Information') }}" data-modal-hide="static-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center">Here!</a>
                                </div>
                            </div>
                        </div>
                    </div>
