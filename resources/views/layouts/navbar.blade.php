                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-4 md:p-5 md:flex items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <p class="text-2xl md:text-4xl leading-relaxed text-black mx-2 font-bold">{{ Auth::user()->username }}</p>
                                        <p class="text-sm leading-relaxed text-gray-500 mx-2 mb-4">{{ Auth::user()->email }}</p>
                                    </div>
                                </div>
